...
if __name__ == '__main__':
    ...
    parser.add_argument('--network', default='video', type=str)
    parser.add_argument('--gpu', default=0, type=int)
    parser.add_argument('--embedding_dim', default=16, type=int)
    parser.add_argument('--num_layer_kf', default=1, type=int)
    parser.add_argument('--reg_factor1', default=0.01, type=float)
    ...
    parser.add_argument('--add_state_change_loss', default=True, action='store_false')
    args = parser.parse_args()
    args.postfix = '{}-{}-{}-{}-{}-{}'.format(args.network, args.embedding_dim, args.num_layer_kf, args.reg_factor1, args.reg_factor2, args.lr)
